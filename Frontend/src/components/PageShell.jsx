    ...
    <div className="authenticated-shell" dir="rtl">
      <aside className="app-sidebar" aria-label="ניווט ראשי">
        ...
        <nav className="sidebar-nav">
          ...
          {isAdmin && <a className={`route-messages ${activeRoute === 'messages' ? 'active' : ''}`} href={routes.messages.path} onClick={(e) => navigate(e, 'messages')}><i>{icons.comments}</i><span>הודעות</span></a>}
      ...
      <nav className="mobile-nav" aria-label="ניווט לנייד" ref={mobileNavRef} data-scrollable="horizontal">
        ...
        {isAdmin && <a data-route="messages" className={activeRoute === 'messages' ? 'active' : ''} href={routes.messages.path} onClick={(e) => navigate(e, 'messages')}><i>{icons.comments}</i><span>הודעות</span></a>}
